...
abstract class $DoctorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String uid, String userName});
}
...
class _$_Doctor implements _Doctor {
  _$_Doctor({required this.name, required this.uid, required this.userName});
  ...
  @override
  String toString() {
    return 'Doctor(name: $name, uid: $uid, userName: $userName)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, uid, userName);
...
abstract class _Doctor implements Doctor {
  factory _Doctor(
      ...
      required final String userName}) = _$_Doctor;
