...
class _EntryPointState extends ConsumerState<EntryPoint> with SingleTickerProviderStateMixin {
                      ...
                      ...List.generate(
                        ...
                        (index) {
                          ...
                          return BtmNavItem(
                            ...
                            riveOnInit: (artboard) {
                              navBar.rive.status =
                                  RiveUtils.getRiveInput(artboard, stateMachineName: navBar.rive.stateMachineName);
                            },
